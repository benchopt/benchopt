...
If your Python solver requires some packages, benchopt allows you to list
its requirements. See :ref:`specify_requirements` for more details on how to
specify the requirements for benchopt classes.
...
call the Julia solver using `PyJulia <https://pypi.org/project/julia/>`_.
