...
* ``paths``, *list*: Allows users to store some files in custom locations.
  If you are writing your own benchmark, you can use this options to allow
  users to use custom location for some benchmark files like data files for
  instance. Otherwise, please refer to the benchmark's documentation you
